...
// Use only letters, numbers, and underscores — no spaces.
const String SENSOR_ID = "my_esp32_device_1";
...
bool readSensorData(JsonDocument& doc) {
  ...
  //   return true;
  //
  // Example — a simple analog sensor on pin 34:
  //   int rawValue = analogRead(34);
  //   float voltage = rawValue * (3.3f / 4095.0f);
  //   doc.set("voltage", voltage);
  //   return true;
  //
  // ▲▲▲

  // Remove this line once you have added your sensor code above
  Serial.println("WARNING: readSensorData() has no sensor code yet!");
  return false;
}
